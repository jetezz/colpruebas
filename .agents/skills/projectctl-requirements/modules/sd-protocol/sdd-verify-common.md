...
- `.agents/skills/projectctl-requirements/modules/sd-protocol/sdd-phase-common.md` §F — universal executor boilerplate.
- `.agents/skills/projectctl-requirements/modules/sd-protocol/apply-work-unit-schema.md` §6 — verification mapping by lane.
