...
Este archivo no duplica valores del bloque `task-flow-binding` (`TaskFlowBindingV1`, v9.0.0).
...
> `REPO_ROOT`), emite exactamente **22 project skills** y **excluye por contrato** las
...
> `metadata.version` del package per `maintenance.md` §5. **last-verified: 2026-08-04**
...
> El binding integral vive en el bloque delimitado `task-flow-binding` (`TaskFlowBindingV1`, v9.0.0) dentro de `.agents/skills/projectctl-requirements/references/tareas.md`.
