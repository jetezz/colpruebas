---
title: "State test: p1_revision_requested"
...
phase_artifacts_dir: "taskReadme/20260727-p1revis-state-p1-revision-requested/"
status: planning
...
# State test: p1_revision_requested

## Purpose
Display one task in the canonical workflow state `p1_revision_requested`.
