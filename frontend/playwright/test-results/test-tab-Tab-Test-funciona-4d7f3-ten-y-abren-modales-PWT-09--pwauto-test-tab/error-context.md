...
- Name: test-tab.spec.ts >> Tab Test funcional — @test-tab (PWT-12) >> botones per-criterio PW-CLI y Manual existen y abren modales (PWT-09)
- Location: tests/front/tests/test-tab.spec.ts:101:3
...
Call log:
  - waiting for locator('[data-action="pwcli"]') to be visible
